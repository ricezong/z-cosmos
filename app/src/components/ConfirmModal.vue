...
.confirm-icon { font-size: 2.5rem; color: rgba(180,160,240,0.85); margin-bottom: 12px; }
.confirm-modal h3 { font-size: 1.1rem; font-weight: 500; color: #e8eef7; margin-bottom: 8px; }
.confirm-modal p { font-size: 0.9rem; color: rgba(239,236,251,0.65); margin-bottom: 24px; line-height: 1.6; }
.confirm-btns { display: flex; gap: 12px; justify-content: center; }
.confirm-cancel, .confirm-ok {
  padding: 10px 28px; border-radius: 24px; cursor: pointer; font-size: 0.9rem; transition: 0.25s;
}
.confirm-cancel {
  border: 1px solid rgba(180,160,240,0.2); background: rgba(180,160,240,0.05); color: rgba(180,160,240,0.8);
}
.confirm-cancel:hover { background: rgba(180,160,240,0.1); border-color: rgba(180,160,240,0.35); }
.confirm-ok {
  border: none; background: linear-gradient(135deg, rgba(120,100,200,0.7), rgba(180,160,240,0.8)); color: #fff; font-weight: 500;
}
.confirm-ok:hover { box-shadow: 0 4px 18px rgba(180,160,240,0.35); filter: brightness(1.1); }
