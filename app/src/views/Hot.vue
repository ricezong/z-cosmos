...
.date-btn { padding: 10px 18px; border-radius: 30px; cursor: pointer; white-space: nowrap; background: rgba(144,166,196,0.1); border: 1px solid rgba(144,166,196,0.2); color: #a8bcd4; transition: 0.3s; font-size: 0.9rem; }
.date-btn.active, .date-btn:hover { background: rgba(144,166,196,0.3); border-color: rgba(144,166,196,0.5); box-shadow: 0 0 15px rgba(144,166,196,0.15); color: #fff; }
...
.modal-box { border: 1px solid rgba(144,166,196,0.3); border-radius: 24px; max-width: 600px; width: 100%; max-height: 80vh; overflow-y: auto; padding: 30px; box-shadow: 0 25px 50px rgba(0,0,0,0.5); }
