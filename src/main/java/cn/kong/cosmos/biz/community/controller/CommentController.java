...
public class CommentController {
    ...
    public Result<Map<String, String>> create(@PathVariable("postId") String postId,
    ...
    public Result<Void> delete(@PathVariable("commentId") String commentId) {
    ...
    public Result<Void> like(@PathVariable("commentId") String commentId) {
    ...
    public Result<Void> unlike(@PathVariable("commentId") String commentId) {
