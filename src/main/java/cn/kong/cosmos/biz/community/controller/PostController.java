...
public class PostController {
    ...
    /** 帖子详情（公开） */
    @GetMapping("/{postId}")
    public Result<PostDetailDTO> detail(@PathVariable("postId") String postId) {
    ...
    /** 编辑帖子（作者） */
    @PutMapping("/{postId}")
    public Result<Void> update(@PathVariable("postId") String postId, @Valid @RequestBody UpdatePostReq req) {
    ...
    public Result<Void> delete(@PathVariable("postId") String postId) {
    ...
    public Result<Void> like(@PathVariable("postId") String postId) {
    ...
    public Result<Void> unlike(@PathVariable("postId") String postId) {
    ...
    public Result<Void> collect(@PathVariable("postId") String postId) {
    ...
    public Result<Void> uncollect(@PathVariable("postId") String postId) {
