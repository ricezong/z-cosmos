...
.page-layout {
  --bt-bg: rgba(240,195,115,0.25);
  --bt-border: rgba(240,195,115,0.45);
  --bt-color: #fff;
  --bt-hover-bg: rgba(240,195,115,0.45);
  --bt-shadow: rgba(240,195,115,0.3);
}
...
.edit-card-header h3 { font-size: 1.05rem; font-weight: 500; color: #f5d19a; display: flex; align-items: center; gap: 8px; }
...
.header-title h1 { font-size: 1.8rem; font-weight: 300; letter-spacing: 4px; background: linear-gradient(135deg, #ffffff, #f3e0b0); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
.header-title p { font-size: 0.85rem; opacity: 0.7; margin-top: 2px; }
.back-btn { padding: 8px 20px; border-radius: 30px; background: rgba(240,195,115,0.1); border: 1px solid rgba(240,195,115,0.25); color: #f5d19a; cursor: pointer; text-decoration: none; transition: 0.3s; font-size: 0.9rem; }
.back-btn:hover { background: rgba(240,195,115,0.2); box-shadow: 0 0 15px rgba(240,195,115,0.2); }
.planet-sphere { width: 36px; height: 36px; border-radius: 50%; position: relative; flex-shrink: 0; }
.planet-sphere.sun { background: radial-gradient(circle at 35% 35%, #f6deab, #e7bc6b 40%, #c89a50 70%, #7a5224 100%); box-shadow: 0 0 16px rgba(240,195,115,0.7), 0 0 32px rgba(230,175,95,0.4), 0 0 50px rgba(220,160,80,0.2), inset 0 0 6px rgba(255,255,255,0.2); }
.planet-sphere.sun::after { content: ''; position: absolute; inset: 8% 22% 38% 18%; background: rgba(255,255,255,0.2); border-radius: 50%; }
.tabs { display: flex; gap: 10px; }
.tab { padding: 10px 24px; border-radius: 30px; cursor: pointer; background: rgba(240,195,115,0.06); border: 1px solid rgba(240,195,115,0.15); color: #c8a870; transition: 0.3s; font-size: 0.95rem; }
.tab.active, .tab:hover { background: rgba(240,195,115,0.15); border-color: rgba(240,195,115,0.35); color: #f3e0b0; box-shadow: 0 0 15px rgba(240,195,115,0.1); }
.empty-state { text-align: center; padding: 60px 20px; opacity: 0.5; }
.empty-state p { margin-bottom: 12px; }
.go-link { color: #e7bc6b; text-decoration: none; transition: 0.3s; }
.go-link:hover { color: #f3e0b0; }

/* Profile Card */
.profile-card { background: rgba(22,20,44,0.62); border: 1px solid rgba(240,195,115,0.18); border-radius: 20px; padding: 28px; margin-bottom: 22px; backdrop-filter: blur(10px); box-shadow: 0 8px 28px rgba(0,0,0,0.25); }
.profile-header { display: flex; align-items: center; gap: 20px; }
.avatar { width: 64px; height: 64px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 28px; font-weight: bold; color: #fff; flex-shrink: 0; box-shadow: 0 0 20px rgba(240,195,115,0.35); }
...
.edit-btn { padding: 8px 16px; border-radius: 20px; border: 1px solid rgba(240,195,115,0.25); background: rgba(240,195,115,0.08); color: #f5d19a; cursor: pointer; font-size: 0.85rem; transition: 0.3s; white-space: nowrap; }
.edit-btn:hover { background: rgba(240,195,115,0.18); }
...
.section-title { font-weight: 400; margin-bottom: 16px; color: #f3e0b0; letter-spacing: 2px; font-size: 1.05rem; }

/* Avatar Picker */
.avatar-picker { display: flex; flex-wrap: wrap; gap: 10px; }
.avatar-option { width: 44px; height: 44px; border-radius: 50%; background: rgba(240,195,115,0.06); border: 1px solid rgba(240,195,115,0.15); display: flex; align-items: center; justify-content: center; cursor: pointer; font-size: 20px; color: #c8a870; transition: 0.3s; }
.avatar-option:hover { background: rgba(240,195,115,0.15); }
.avatar-option.active { border-color: #e7bc6b; background: rgba(255,192,64,0.2); box-shadow: 0 0 10px rgba(255,192,64,0.3); color: #fff; }
...
.edit-panel input:focus, .edit-panel textarea:focus { border-color: rgba(240,195,115,0.45); }
.save-btn { padding: 10px 28px; border-radius: 24px; border: none; background: linear-gradient(135deg, #c89a50, #e7bc6b); color: #1a0800; cursor: pointer; font-size: 0.9rem; transition: 0.3s; font-weight: 500; }
...
.login-link { display: inline-block; padding: 12px 36px; border-radius: 30px; background: linear-gradient(135deg, #c89a50, #e7bc6b); color: #1a0800; text-decoration: none; font-size: 1rem; transition: 0.3s; margin-bottom: 15px; font-weight: 500; }
...
.post-card { background: rgba(35,20,8,0.5); border: 1px solid rgba(240,195,115,0.1); border-radius: 16px; padding: 20px; backdrop-filter: blur(8px); cursor: pointer; transition: 0.3s; }
.post-card:hover { border-color: rgba(240,195,115,0.3); box-shadow: 0 5px 25px rgba(0,0,0,0.2); transform: translateY(-2px); }
.post-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; }
.post-category-tag { display: inline-block; padding: 3px 10px; border-radius: 10px; font-size: 0.75rem; background: rgba(255,192,64,0.12); color: #f5d19a; border: 1px solid rgba(255,192,64,0.22); text-transform: capitalize; }
